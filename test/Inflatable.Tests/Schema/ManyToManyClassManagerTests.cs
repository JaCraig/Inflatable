...
namespace Inflatable.Tests.Schema
{
    public class ManyToManyClassManagerTests : TestingFixture
    {
        ...
        public void Creation()
        {
            ...
            Assert.True(TestModel.SourceSpec.Tables.Any(x => x.Name == "ManyToManyProperties_"));
            Assert.True(TestModel.SourceSpec.Tables.Any(x => x.Name == "AllReferencesAndID_ManyToManyProperties"));
