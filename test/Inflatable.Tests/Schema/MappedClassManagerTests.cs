...
namespace Inflatable.Tests.Schema
{
    public class MappedClassManagerTests : TestingFixture
    {
        ...
        public void Creation()
        {
            ...
            Assert.Contains("CREATE TABLE [dbo].[MapProperties_]([ID_] Int NOT NULL PRIMARY KEY IDENTITY,[BoolValue_] Bit NOT NULL,[AllReferencesAndID_ID_] Int)", TestModel.GeneratedSchemaChanges);
