...
namespace Inflatable.Tests.Schema
{
    public class MappedClassManagerTests : TestingFixture
    {
        ...
        public void Creation()
        {
            ...
            Assert.Contains("ALTER TABLE [dbo].[MapProperties_] ADD FOREIGN KEY ([AllReferencesAndID_ID_]) REFERENCES [dbo].[AllReferencesAndID_]([ID_]) ON DELETE CASCADE ON UPDATE CASCADE", TestModel.GeneratedSchemaChanges);
        }
    }
}