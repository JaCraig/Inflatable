...
namespace Inflatable.Tests.QueryProvider.Providers.SQLServer.QueryGenerators
{
    ...
    public class LoadDataQueryTests : TestingFixture
    {
        ...
        public void GenerateQueryWithManyToManyProperties()
        {
            ...
            Assert.Equal(TestConnectionStrings.NormalizeLineEndings("SELECT [dbo].[ManyToManyProperties_].[ID_] AS [ID],[dbo].[ManyToManyProperties_].[BoolValue_] AS [BoolValue]\r\nFROM [dbo].[ManyToManyProperties_]\r\nWHERE ([dbo].[ManyToManyProperties_].[ID_]=@ID0);"), TestConnectionStrings.NormalizeLineEndings(Result.QueryString));
            Assert.Equal(QueryType.LoadData, Result.QueryType);
        }
        ...
        public void GenerateQueryWithManyToOneManyFromComplexGraphProperties()
        {
            ...
            Assert.Equal("ID0", Result.Parameters[0].ID);
            Assert.Equal(TestConnectionStrings.NormalizeLineEndings("SELECT [dbo].[IManyToOneMany_].[ID_] AS [ID],[dbo].[IManyToOneMany_].[BoolValue_] AS [BoolValue]\r\nFROM [dbo].[ManyToOneManyFromComplexClass_]\r\nINNER JOIN [dbo].[IManyToOneMany_] ON [dbo].[ManyToOneManyFromComplexClass_].[IManyToOneMany_ID_]=[dbo].[IManyToOneMany_].[ID_]\r\nWHERE ([dbo].[IManyToOneMany_].[ID_]=@ID0);"), TestConnectionStrings.NormalizeLineEndings(Result.QueryString));
            Assert.Equal(QueryType.LoadData, Result.QueryType);
        }
        ...
        public void GenerateQueryWithManyToOneManyProperties()
        {
            ...
            Assert.Equal(1, Result.Parameters[0].InternalValue);
            Assert.Equal("ID0", Result.Parameters[0].ID);
            Assert.Equal(TestConnectionStrings.NormalizeLineEndings("SELECT [dbo].[ManyToOneManyProperties_].[ID_] AS [ID],[dbo].[ManyToOneManyProperties_].[BoolValue_] AS [BoolValue]\r\nFROM [dbo].[ManyToOneManyProperties_]\r\nWHERE ([dbo].[ManyToOneManyProperties_].[ID_]=@ID0);"), TestConnectionStrings.NormalizeLineEndings(Result.QueryString));
            Assert.Equal(QueryType.LoadData, Result.QueryType);
        }
        ...
        public void GenerateQueryWithManyToOneOneFromComplexGraphProperties()
        {
            ...
            Assert.Equal(1, Result.Parameters[0].InternalValue);
            Assert.Equal("ID0", Result.Parameters[0].ID);
            Assert.Equal(TestConnectionStrings.NormalizeLineEndings("SELECT [dbo].[IManyToOneOne_].[ID_] AS [ID],[dbo].[IManyToOneOne_].[BoolValue_] AS [BoolValue]\r\nFROM [dbo].[ManyToOneOneFromComplexClass_]\r\nINNER JOIN [dbo].[IManyToOneOne_] ON [dbo].[ManyToOneOneFromComplexClass_].[IManyToOneOne_ID_]=[dbo].[IManyToOneOne_].[ID_]\r\nWHERE ([dbo].[IManyToOneOne_].[ID_]=@ID0);"), TestConnectionStrings.NormalizeLineEndings(Result.QueryString));
            Assert.Equal(QueryType.LoadData, Result.QueryType);
        }
        ...
        public void GenerateQueryWithManyToOneSingleProperties()
        {
            ...
            Assert.Equal(1, Result.Parameters[0].InternalValue);
            Assert.Equal("ID0", Result.Parameters[0].ID);
            Assert.Equal(TestConnectionStrings.NormalizeLineEndings("SELECT [dbo].[ManyToOneOneProperties_].[ID_] AS [ID],[dbo].[ManyToOneOneProperties_].[BoolValue_] AS [BoolValue]\r\nFROM [dbo].[ManyToOneOneProperties_]\r\nWHERE ([dbo].[ManyToOneOneProperties_].[ID_]=@ID0);"), TestConnectionStrings.NormalizeLineEndings(Result.QueryString));
            Assert.Equal(QueryType.LoadData, Result.QueryType);
        }
        ...
        public void GenerateQueryWithMapProperties()
        {
            ...
            Assert.Equal(1, Result.Parameters[0].InternalValue);
            Assert.Equal("ID0", Result.Parameters[0].ID);
            Assert.Equal(TestConnectionStrings.NormalizeLineEndings("SELECT [dbo].[MapProperties_].[ID_] AS [ID],[dbo].[MapProperties_].[BoolValue_] AS [BoolValue]\r\nFROM [dbo].[MapProperties_]\r\nWHERE ([dbo].[MapProperties_].[ID_]=@ID0);"), TestConnectionStrings.NormalizeLineEndings(Result.QueryString));
            Assert.Equal(QueryType.LoadData, Result.QueryType);
        }
        ...
        public void GenerateQueryWithMapPropertiesComplex()
        {
            ...
            Assert.Equal(1, Result.Parameters[0].InternalValue);
            Assert.Equal("ID0", Result.Parameters[0].ID);
            Assert.Equal(TestConnectionStrings.NormalizeLineEndings("SELECT [dbo].[IMapPropertiesInterface_].[ID_] AS [ID],[dbo].[IMapPropertiesInterface_].[BoolValue_] AS [BoolValue]\r\nFROM [dbo].[MapPropertiesFromComplexClass_]\r\nINNER JOIN [dbo].[IMapPropertiesInterface_] ON [dbo].[MapPropertiesFromComplexClass_].[IMapPropertiesInterface_ID_]=[dbo].[IMapPropertiesInterface_].[ID_]\r\nWHERE ([dbo].[IMapPropertiesInterface_].[ID_]=@ID0);"), TestConnectionStrings.NormalizeLineEndings(Result.QueryString));
            Assert.Equal(QueryType.LoadData, Result.QueryType);
        }
        ...
        public void GenerateQueryWithMapToSelfOnInterface()
        {
            ...
            Assert.Equal(1, Result.Parameters[0].InternalValue);
            Assert.Equal("ID0", Result.Parameters[0].ID);
            Assert.Equal(TestConnectionStrings.NormalizeLineEndings("SELECT [dbo].[IMapPropertiesInterfaceWithMap_].[ID_] AS [ID],[dbo].[MapPropertiesWithMapOnInterface_].[BoolValue_] AS [BoolValue]\r\nFROM [dbo].[MapPropertiesWithMapOnInterface_]\r\nINNER JOIN [dbo].[IMapPropertiesInterfaceWithMap_] ON [dbo].[MapPropertiesWithMapOnInterface_].[IMapPropertiesInterfaceWithMap_ID_]=[dbo].[IMapPropertiesInterfaceWithMap_].[ID_]\r\nWHERE ([dbo].[IMapPropertiesInterfaceWithMap_].[ID_]=@ID0);"), TestConnectionStrings.NormalizeLineEndings(Result.QueryString));
            Assert.Equal(QueryType.LoadData, Result.QueryType);
        }
    }
}