...
", Result.GenerateDeclarations(QueryType.Insert).QueryString);
...
", Result.GenerateQuery(QueryType.Insert, new ConcreteClass1()).QueryString);
...
INNER JOIN [dbo].[IInterface1_] ON [dbo].[BaseClass1_].[IInterface1_ID_]=[dbo].[IInterface1_].[ID_]
WHERE [dbo].[IInterface1_].[ID_]=@ID;
", Result.GenerateQuery(QueryType.Update, new ConcreteClass1()).QueryString);
...
FROM [dbo].[ConcreteClass1_]
INNER JOIN [dbo].[BaseClass1_] ON [dbo].[ConcreteClass1_].[BaseClass1_ID_]=[dbo].[BaseClass1_].[ID_]
INNER JOIN [dbo].[IInterface1_] ON [dbo].[BaseClass1_].[IInterface1_ID_]=[dbo].[IInterface1_].[ID_];", Result.GenerateQuery(QueryType.LinqQuery, new ConcreteClass1()).QueryString);
        }
        ...
        public void GenerateDefaultQueriesConcreteClass2()
        {
            ...
            Assert.Equal("DELETE FROM [dbo].[IInterface1_] WHERE [dbo].[IInterface1_].[ID_]=@ID;\r\n", Result.GenerateQuery(QueryType.Delete, new ConcreteClass2()).QueryString);

            Assert.Equal(@"DECLARE @IInterface1_ID_Temp AS INT;

DECLARE @BaseClass1_ID_Temp AS BIGINT;

DECLARE @ConcreteClass2_ID_Temp AS BIGINT;
", Result.GenerateDeclarations(QueryType.Insert).QueryString);
...
", Result.GenerateQuery(QueryType.Insert, new ConcreteClass2()).QueryString);
...
INNER JOIN [dbo].[IInterface1_] ON [dbo].[BaseClass1_].[IInterface1_ID_]=[dbo].[IInterface1_].[ID_]
WHERE [dbo].[IInterface1_].[ID_]=@ID;
", Result.GenerateQuery(QueryType.Update, new ConcreteClass2()).QueryString);
...
FROM [dbo].[ConcreteClass2_]
INNER JOIN [dbo].[BaseClass1_] ON [dbo].[ConcreteClass2_].[BaseClass1_ID_]=[dbo].[BaseClass1_].[ID_]
INNER JOIN [dbo].[IInterface1_] ON [dbo].[BaseClass1_].[IInterface1_ID_]=[dbo].[IInterface1_].[ID_];", Result.GenerateQuery(QueryType.LinqQuery, new ConcreteClass2()).QueryString);
        }
        ...
        public void GenerateDefaultQueriesConcreteClass3()
        {
            ...
            Assert.Equal("DELETE FROM [dbo].[IInterface1_] WHERE [dbo].[IInterface1_].[ID_]=@ID;\r\n", Result.GenerateQuery(QueryType.Delete, new ConcreteClass3()).QueryString);

            Assert.Equal(@"DECLARE @IInterface1_ID_Temp AS INT;

DECLARE @ConcreteClass3_ID_Temp AS BIGINT;
", Result.GenerateDeclarations(QueryType.Insert).QueryString);
...
", Result.GenerateQuery(QueryType.Insert, new ConcreteClass3()).QueryString);
...
WHERE [dbo].[IInterface1_].[ID_]=@ID;
", Result.GenerateQuery(QueryType.Update, new ConcreteClass3()).QueryString);

            Assert.Equal(@"SELECT [dbo].[IInterface1_].[ID_] AS [ID],[dbo].[ConcreteClass3_].[MyUniqueProperty_] AS [MyUniqueProperty]
FROM [dbo].[ConcreteClass3_]
INNER JOIN [dbo].[IInterface1_] ON [dbo].[ConcreteClass3_].[IInterface1_ID_]=[dbo].[IInterface1_].[ID_];", Result.GenerateQuery(QueryType.LinqQuery, new ConcreteClass3()).QueryString);
        }
    }
}