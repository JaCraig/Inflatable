...
namespace Inflatable.ClassMapper.BaseClasses
{
    ...
    /// <seealso cref="Interfaces.IManyToOneProperty{ClassType, DataType, ReturnType}"/>
    /// <seealso cref="Interfaces.IManyToOneProperty{ClassType, DataType}"/>
    public abstract class ManyToOneManyPropertyBase<ClassType, DataType, ReturnType> : IManyToOneProperty<ClassType, IList<DataType>, ReturnType>, IManyToOneProperty<ClassType, IList<DataType>>
        ...
        where DataType : class
    {
        ...
        {
            var SecondObj = obj as ManyToOneManyPropertyBase<ClassType, DataType, ReturnType>;
        ...
        public bool Similar(IManyToOneProperty secondProperty)
        {
            return secondProperty.Name == Name;
        }
